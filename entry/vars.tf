variable "ak" {  default = "BVJJOKERVFQTWJTUHRHB" }
variable "sk" {  default = "gYJrIAsjutlgqu2HlQDENgflaBazvlSu3uvEFxef" }
...
variable "rds_instance_mode" {  default = "ha" }
variable "rds_group_type" {  default = "dedicated" }
